<!--
STAGE 1 PROMPT (paper_v1 variant): node extraction, tightened to reduce
over-generation. Every constraint is a paper lever, and the citations are kept
HERE in the comment, not in the prompt body:
